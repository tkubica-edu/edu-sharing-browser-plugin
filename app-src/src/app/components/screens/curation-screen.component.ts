...
// "Inhalt erschließen": runs the metadata agent on the open page and hands its result to the next
// step, where its picture and title are checked (CurationPreviewScreenComponent).
//
...
// the preview step, and a failure stays here with the error and the footer's retry.
//
